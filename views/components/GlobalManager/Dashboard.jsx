                ...
                <nav className="col-md-2 d-none d-md-block  sidebar bg-white rounded box-shadow">
                    <div className="sidebar-sticky" style={{ position: 'relative'}}>
                        ...
                        <Icon
                            ...
                            dataToggle = 'tooltip'
                            position   = 'bottom'
                            tipTitle   = 'Watch sellers'
                        />    
                      
                        <Icon
                            text  = 'New Seller'
                            clase = 'nav-link icon-form'
                        ...
                        <Icon
                            ...
                            clase = 'nav-link icon-route'
                            someClick = { props.onGetOfficeManagersData }

                            dataToggle = 'tooltip'
                            position   = 'bottom'
                            tipTitle   = 'Watch office manager'
                        />    
