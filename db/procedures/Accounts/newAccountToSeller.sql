...
-- call newAccountToSeller('invited', 'invited@nissan.mx', '0', 'invited', 1);
-- call newAccountToSeller('carlos', 'carlos@nissan.mx', '0', 'invited', 3);

-- CALL newAccountToSeller('username', 'email@ds', 'password', 'typeAccount', 'id_seller');
