...
CREATE TABLE global_managers (
    ...
    job                 VARCHAR(45) DEFAULT 'Global Manager',
...
INSERT INTO global_managers (name, lastname, phone, address, city, state, postal_code, country)
...
VALUES ('Linda', 'Mendoza', '3122567809', 'street nose #3456', 'Colima','Colima', '28045', 'Mexico', 1);

INSERT INTO office_managers (name, lastname, phone, address, city, state, postal_code, country, id_global_manager)
VALUES ('Antonio', 'Llanos', '3122534857', 'Av. Miguel de la Madrid #3356', 'Manzanillo','Colima', '28019', 'Mexico', 1);
...
CREATE TABLE offices (
    ...
    REFERENCES global_managers (id_global_manager),

    FOREIGN KEY (id_office_manager)
    REFERENCES office_managers (id_office_manager)
);
...
VALUES (now(), 631000, 'uno apartado y uno vendido');
INSERT INTO orders (date_at, amount, coments)
